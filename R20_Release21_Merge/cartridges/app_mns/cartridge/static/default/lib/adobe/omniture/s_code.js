...
var s_account = "mnsintfrdev";
var s_prefix = "dev:";
if (hn.indexOf("marksandspencer.fr") > -1) {
	s_account = "mnsintfrprod";
	s_prefix = ""
}
...
s.linkInternalFilters = "javascript:,.marksandspencer.fr,demandware.net";
...
s._channelPattern = "Affiliates|af_>Business Media|msfb_>EMWA|emwa>Email|em>Food Media|fd>Indexed Tags|a_msf,b_msf>Media|me>Paid Search|ggl_,ovt_,ps_>Product Feed|c_msf,crit_msf,f_ms,k_msf,pg_msf,s_msf>Social Media|facebook,fb,tw>Traffic Partner|tp_>Video|vid_";
...
s.nullSearchEvent = "event48";
s.searchTermVariable = "eVar2";
function normalized(b) {
	return (b.indexOf(s_prefix) == 0)
}
function normalizeContent(d, c) {
	if (c) {
		c = c.toLowerCase();
		if (c.indexOf("&amp;") >= 0) {
			c = d.repl(c, "&amp;", "&")
...
function fixContentVars(c) {
	if (c.prop18 && c.eVar25 && (c.prop18 == c.eVar25)) {
		c.eVar25 = "D=c18"
	}
	var d = c.prop18;
	if (!d) {
	...
	if (c.pageName && !normalized(c.pageName)) {
		if (d && d.indexOf(c.pageName) >= 0) {
			c.pageName = d
		} else {
			if (c.prop24 && (c.prop24 == "Product Detail Page")) {
				c.pageName = d + ":" + c.products
			} else {
				if (c.prop24
						&& (c.prop24 == "Content Page"
								|| c.prop24 == "My Account Page" || c.prop24 == "Search Result Page")) {
					c.pageName = d + ":" + c.pageName
				} else {
					if (c.prop24 && (c.prop24 == "Home Page")) {
						c.pageName = d + ":Home Page"
					}
				}
			}
		}
		c.channel = normalizeContent(c, c.channel);
		c.prop1 = normalizeContent(c, c.prop1);
		c.prop18 = normalizeContent(c, c.prop18)
	}
	if (c.products && c.products.indexOf("Parent_") >= 0) {
		c.products = c.repl(c.products, "Parent_", "")
	}
	while (c.products && c.products.indexOf("/") >= 0) {
		c.products = c.repl(c.products, "/", "")
	}
}
function s_doPlugins(a) {
	a.prop10 = a.pageName;
	if (a.campaign) {
		a.prop10 += " CMP: " + a.campaign
	}
	a.prop45 = "D=Host";
	fixContentVars(a);
	if (a.prop3) {
		a.prop3 = a.repl(a.prop3, ".0", "")
	}
	if (a.events) {
		a.events = a.repl(a.events, " ", "")
	}
	a.eVar5 = a.getTimeParting("h", "1");
	a.eVar6 = a.getTimeParting("d", "0");
	a.eVar7 = a.getTimeParting("w", "0");
	a.eVar30 = a.getNewRepeat();
	a.channelManager("cid,cmpid,extid", "", "s_cm", "", "s_dl");
	a.campaign = a._campaignID;
	a.eVar8 = a._channel;
	if (!a.eVar21 && a.eVar8) {
		a.eVar21 = a.crossVisitParticipation(a.eVar8, "s_chst", "7", "5",
				" > ", "purchase", "0")
	}
	if (!a.eVar20 && a.campaign) {
		a.eVar20 = a.crossVisitParticipation(a.campaign, "s_cmst", "7", "5",
				" > ", "purchase", "0")
	}
	a.eVar46 = a.getQueryParam("kwid");
	a.eVar15 = a.getAndPersistValue(a.getQueryParam("deviceID"), "s_did", 30);
	if (!a.eVar15) {
		a.eVar15 = "non-store"
	}
	a.eVar53 = a.getAndPersistValue(a.getQueryParam("orderPoint"), "s_ord", 30);
	if (!a.eVar53) {
		a.eVar53 = "non-store"
	}
	a.eVar54 = a.getAndPersistValue(a.getQueryParam("orderChannel"), "s_och",
			30);
	if (!a.eVar54) {
		a.eVar54 = "non-store"
	}
	if (!a.eVar1) {
		a.eVar1 = a.getQueryParam("icid")
	}
	if (!a.eVar1) {
		a.eVar1 = a.getQueryParam("intid")
	}
	if (a.eVar2) {
		a.eVar2 = a.eVar2.toLowerCase()
	}
	var o = a.getValOnce(a[a.searchTermVariable], "ev1", 0);
	if (o == "") {
		if (a.events && a.events.indexOf(a.successfulSearchEvent) >= 0) {
			var f = a.split(a.events, ",");
			var i = "";
			for ( var r = 0; r < f.length; r++) {
				if (f[r] == a.successfulSearchEvent) {
					continue
				} else {
					if (f[r] == a.nullSearchEvent) {
						continue
					} else {
						i += f[r] ? f[r] + "," : f[r]
					}
			...
			a.events = i.substring(0, i.length - 1)
		}
	} else {
		if (!a.products) {
			a.products = ";"
	...
	a.setupDynamicObjectIDs();
	if (!a.eVar14 && a.campaign && (a.campaign != "n/a")) {
		a.eVar14 = "external campaign"
	}
	if (a.eVar2 && !a.eVar14) {
		a.eVar14 = "internal search"
	}
	if (a.eVar1 && !a.eVar14) {
		a.eVar14 = "internal campaign"
	}
	if (document.referrer && !a.eVar14) {
		var t = a.split(a.linkInternalFilters, ",");
		var e = false;
		var q = a.split(document.referrer, "/");
		q = q[2];
		for ( var p in t) {
			if (q.indexOf(t[p]) > -1) {
				e = true
		...
		if (!e) {
			a.eVar14 = "external non-campaign"
		}
	}
	a.prop9 = a.getAndPersistValue(a.campaign, "s_cmp_pages");
	if (a.channel && !a.eVar18) {
		a.eVar18 = "D=ch"
	}
	if (a.eVar2 && !a.prop2) {
		a.prop2 = "D=v2"
	...
	if (a.purchaseID && !a.eVar3) {
		a.eVar3 = a.purchaseID
	}
	if (!a.eVar25) {
		a.eVar25 = "Non-Browse"
	}
...
s.visitorNamespace = "marksandspencer";
...
s.setOIDs = new Function(
		...
		"var s=s_c_il["
				+ s._in
				+ "],b=s.eh(s.wd,'onload'),o='onclick',x,l,u,c,i,a=new Array;if(s.doiol){if(b)s[b]=s.wd[b];s.doiol(e)}if(s.d.links){for(i=0;i<s.d.links.length;i++){l=s.d.links[i];c=l[o]?''+l[o]:'';b=s.eh(l,o);z=l[b]?''+l[b]:'';u=s.getObjectID(l);if(u&&c.indexOf('s_objectID')<0&&z.indexOf('s_objectID')<0){u=s.repl(u,'\"','');u=s.repl(u,'\\n','').substring(0,97);l.s_oc=l[o];a[u]=a[u]?a[u]+1:1;x='';if(c.indexOf('.t(')>=0||c.indexOf('.tl(')>=0||c.indexOf('s_gs(')>=0)x='var x=\".tl(\";';x+='s_objectID=\"'+u+'_'+a[u]+'\";return this.s_oc?this.s_oc(e):true';if(s.isns&&s.apv>=5)l.setAttribute(o,x);l[o]=new Function('e',x)}}}s.wd.s_semaphore=0;return true");
s.getTimeToComplete = new Function(
		"v",
		"cn",
		"e",
		"var s=this,d=new Date,x=d,k;if(!s.ttcr){e=e?e:0;if(v=='start'||v=='stop')s.ttcr=1;x.setTime(x.getTime()+e*86400000);if(v=='start'){s.c_w(cn,d.getTime(),e?x:0);return '';}if(v=='stop'){k=s.c_r(cn);if(!s.c_w(cn,'',d)||!k)return '';v=(d.getTime()-k)/1000;var td=86400,th=3600,tm=60,r=5,u,un;if(v>td){u=td;un='days';}else if(v>th){u=th;un='hours';}else if(v>tm){r=2;u=tm;un='minutes';}else{r=.2;u=1;un='seconds';}v=v*r/u;return (Math.round(v)/r)+' '+un;}}return '';");
...
function s_gi(u, n, e) {
	...
	if (u) {
		...
		if (w) {
			for (v = 0; v < w.length; v++) {
				...
				c = l._c;
				if ((!c || c == "s_c" || c == "s_l")
						&& (l.oun == u || (l.fs && l.sa && l.fs(l.oun, u)))) {
					if (l.sa) {
						l.sa(u)
					}
					if (c == "s_c") {
	...
	i = s_d(i);
	if (m > 0) {
		a = parseInt(v = D.substring(m + 5));
		if (a > 3) {
			a = parseFloat(v)
		}
	} else {
		if (x > 0) {
			a = parseFloat(C.substring(x + 10))
		} else {
			a = parseFloat(D)
		}
	}
	if (a < 5 || D.indexOf("Opera") >= 0 || C.indexOf("Opera") >= 0) {
		i = s_ft(i)
	}
	if (!l) {
		l = new Object;
	...
	l._c = "s_c";
	(new Function("s", "un", "pg", "ss", i))(l, u, n, e);
	return l
};
