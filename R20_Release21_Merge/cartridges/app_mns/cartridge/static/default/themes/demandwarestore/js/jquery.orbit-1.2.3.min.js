...
"false")return!1;c.append('<div class="slider-nav"><span class="sn_right">Right</span><span class="sn_left">Left</span></div>');var k=c.children("div.slider-nav").children("span.sn_left"),w=c.children("div.slider-nav").children("span.sn_right");k.click(function(){n();l("prev")});w.click(function(){n();l("next")})}if(a.bullets){c.append('<ul class="orbit-bullets"></ul>');var C=c.children("ul.orbit-bullets");for(i=0;i<p;i++){k=d("<li><span>"+(i+1)+"</span></li>");if(a.bulletThumbs&&(w=e.eq(i).data("thumb")))k=d('<li class="has-thumb">'+
