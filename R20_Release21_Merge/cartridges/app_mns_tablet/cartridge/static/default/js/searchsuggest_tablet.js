...
(function(app){
	if (app) {
		...
		app.searchsuggest = {
			...
			init : function(formId, fieldId,formButton, fieldDefault, resultsId, url) {
				// initialize vars
				app.searchsuggest.acFormId = "#" + formId;
				app.searchsuggest.acSearchId = "#" + fieldId;
				app.searchsuggest.acSearchButton = "#" + formButton;
				...
				jQuery(app.searchsuggest.acFormId).submit(function() {
					jQuery(app.searchsuggest.acSearchButton).css("background-color","#A9C14B");
			...
			repositionResultsDiv : function()
			{
				...
				app.searchsuggest.acResultsDiv.css("top", inTop + inHeight + 2);
				app.searchsuggest.acResultsDiv.css("width", inWidth + 10 + 63); // to tweak
